...
- feat: add RSS feed, robots.txt and improve the sitemap (8d3c72d)

## [1.7.0] - 2026-08-12

### Added

- feat: validate article structure in CI and fix duplicated intros (57af794)

## [1.6.0] - 2026-08-12

### Added

- feat: add Open Graph tags and per-page metadata (8344cdd)
...
- perf: optimise images, add cache headers and fix font loading (64446ad)

## [1.5.3] - 2026-08-12

### Fixed

- fix: render the hero image above the article summary (acf5009)
